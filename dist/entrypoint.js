(function(FuseBox) {
  ...
  FuseBox.pkg('default', {}, function(___scope___) {
    ___scope___.file('entrypoint.js', function(
      exports,
      require,
      module,
      __filename,
    ...
    ___scope___.file('util.js', function(
      exports,
      require,
      module,
      __filename,
      ...
      exports.getLabelIds = (allLabels, labelNames) =>
        Object.values(lodash_pick_1.default(allLabels, labelNames));
      exports.logger = {
    ...
    ___scope___.file('query.js', function(
      exports,
      require,
      module,
      __filename,
      ...
      'use strict';
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.getPullRequestAndLabels = (
        graphqlWithAuth,
        { owner, repo, number },
      ) => {
      ...
      exports.removeLabelsFromLabelable = (
        graphqlWithAuth,
        { labelIds, labelableId },
      ) => {
        const query = `
  ...
  (function(e) {
    ...
    function u(e, n) {
      ...
      if (
        ...
        else if (!m && (47 === e.charCodeAt(0) || 58 === e.charCodeAt(1)))
          return f(e);
      var s = x[a];
      if (!s) {
      ...
      return (
        ...
        p ||
          ...
          p ||
            '.' !== d ||
            ((c = (s.s && s.s.entry) || 'index.js'), (p = s.f[c])),
          p || ((c = d + '.js'), (p = s.f[c])),
          p || (p = s.f[d + '.jsx']),
    ...
    function s(e, r, n) {
      if ((void 0 === n && (n = {}), !m))
        return r(/\.(js|json)$/.test(e) ? h.require(e) : '');
      if (n && n.ajaxed === e)
        return console.error(e, 'does not provide a module');
        ...
        if (4 == i.readyState)
          if (200 == i.status) {
            ...
            /json/.test(n)
              ? (o = 'module.exports = ' + o)
              : /javascript/.test(n) ||
                (o = 'module.exports = ' + JSON.stringify(o));
            var a = t('./', e);
    ...
    function d(e) {
      if (
        null !== e &&
        ['function', 'object', 'array'].indexOf(typeof e) !== -1 &&
        !e.hasOwnProperty('default')
      )
        return Object.isFrozen(e)
          ? void (e.default = e)
          : void Object.defineProperty(e, 'default', {
              value: e,
              writable: !0,
              enumerable: !1,
            });
    ...
    function c(e, r) {
      if (
        (void 0 === r && (r = {}),
        58 === e.charCodeAt(4) || 58 === e.charCodeAt(5))
      )
        return o(e);
      var t = u(e, r);
      ...
      (b.exports = {}),
        ...
        m || !h.require.main
          ? (b.require.main = { filename: './', paths: [] })
          : (b.require.main = h.require.main);
    ...
    m && (h.global = v || p ? {} : window),
      (e = m && 'undefined' == typeof __fbx__dnm__ ? e : module.exports);
    var g = m
      ? v || p
        ? {}
